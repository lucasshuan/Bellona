...
export function EloMatchSimulator({
  ...
  return (
    <div className="mt-1 rounded-2xl bg-white/2 p-4">
      {/* Header */}
      <div className="mb-3 flex items-center gap-2">
        <Gamepad2 className="size-3 text-white/25" />
        <span className="text-[10px] font-bold tracking-wider text-white/25 uppercase">
          {t("title")}
        </span>
      </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-end gap-2">
              ...
              <span className="mb-1.5 text-[9px] font-medium text-white/20">
                vs
              </span>
              <div className="flex flex-col gap-0.5">
                <span className="text-[9px] text-white/30">
        ...
        <div className="ml-auto flex flex-col items-end justify-center gap-3 border-l border-white/6 pr-6 pl-6">
          ...
          <div className="space-y-0.5">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[9px] text-white/30">{t("pts")}</span>
            </div>
          </div>
        </div>
      </div>
...
function SimInput({ value, onChange, accent, wide }: SimInputProps) {
  ...
  return (
    <input
      ...
      className={cn(
        "rounded-lg border border-white/10 bg-white/6 py-1 text-center",
        "text-[11px] font-bold tabular-nums",
        "transition-colors focus:border-white/25 focus:bg-white/10 focus:outline-none",
