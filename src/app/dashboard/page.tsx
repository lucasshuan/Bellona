  ...
  return (
    <main className="grid-surface min-h-screen px-6 py-10 sm:px-10">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <header className="flex flex-col gap-4 rounded-[2rem] border border-white/10 bg-white/4 p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
          <div>
            ...
            <p className="text-muted mt-3 max-w-2xl text-sm leading-7 sm:text-base">
              Sua autenticação está conectada ao Auth.js com persistência em
              banco via Drizzle. Esse painel já está protegido por sessão no
              servidor.
            </p>
          </div>
        ...
        <section className="border-primary/18 bg-primary/8 rounded-[2rem] border p-6 sm:p-8">
          <p className="text-primary font-mono text-xs tracking-[0.24em] uppercase">
            Sugestão de sequência
          </p>
          <div className="text-muted mt-4 grid gap-4 text-sm leading-7 sm:grid-cols-3">
